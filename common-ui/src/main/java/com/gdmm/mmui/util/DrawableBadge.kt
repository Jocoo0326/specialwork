...
class DrawableBadge private constructor(val context: Context,
    ...
    class Builder(private val context: Context) {
        ...
        fun build(): DrawableBadge {
            ...
            if (badgeSize == null) badgeSize(R.dimen.comm_ui_badge_size)
            if (textColor == null) textColor(R.color.comm_ui_badge_text_color)
            if (badgeColor == null) badgeColor(R.color.comm_ui_badge_color)
            if (badgeBorderColor == null) badgeBorderColor(R.color.comm_ui_badge_border_color)
            if (badgeBorderSize == null) badgeBorderSize(R.dimen.comm_ui_badge_border_size)
