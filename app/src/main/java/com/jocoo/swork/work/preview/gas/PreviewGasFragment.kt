...
class PreviewGasFragment :
    ...
    override fun initView(savedInstanceState: Bundle?) {
        binding.apply {
            ...
            val isComplete = actViewModel.state.value.detail?.isComplete ?: false
            val gasAutoGenerated = actViewModel.state.value.detail?.data_get_type == "1"
            btnManualAdd.visibility = if (isComplete || gasAutoGenerated) View.GONE else View.VISIBLE
            mAdapter = PreviewGasAdapter(actViewModel.workType, isComplete || gasAutoGenerated)
